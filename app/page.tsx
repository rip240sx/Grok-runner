...
export default function Game() {
  ...
  useEffect(() => {
    ...
    function drawCharacter(ctx: CanvasRenderingContext2D, p: typeof player.current, animTimer: number, grokImg: HTMLImageElement) {
      const drawX = p.x;
      const drawY = p.y;
      ...
      // ... (left leg, right leg, arms, head, body, image fallback)
    ...
    function loop(now: number) {
      ...
      if (gs.gameOver || gs.transitioning) {
        ...
        // [ALL YOUR ORIGINAL COLLISION, ENEMY, COIN, WORMHOLE LOGIC — UNCHANGED]
      ...
      // [YOUR FULL BACKGROUND, FLOOR, PLATFORMS, COINS, ENEMIES, WORMHOLE DRAWING — UNCHANGED]
  ...
  // [YOUR FULL MenuScreen, HowToPlayScreen, GameOverScreen — UNCHANGED]
  ...
  return (
    <div ref={containerRef} style={{ position: "fixed", top: 0, left: 0, width: "100vw", height: "calc(var(--vh) * 100)", overflow: "hidden", background: "#0b1114", touchAction: "none", userSelect: "none" }}>
      {!isLandscape && <div style={{ /* landscape overlay */ }} />}
...
// PASTE YOUR FULL MenuScreen, HowToPlayScreen, GameOverScreen HERE
