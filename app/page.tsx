...
export default function Game() {
  ...
  useEffect(() => {
    ...
    function drawCharacter(
      ...
      // Arms (simplified for brevity — keep your full arm code if needed)
      ctx.restore()
    }
    ...
    function loop(now: number) {
      ...
      // [Keep your drawing code — simplified here for brevity]
...
// [Keep your MenuScreen, HowToPlayScreen, GameOverScreen exactly as they are]
